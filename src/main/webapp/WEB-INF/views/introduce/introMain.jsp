	...
	<div class="row">
		<div class="col-sm-3 col-md-2 sidebar">
			<ul class="nav nav-sidebar">
				<li><h2>병원 소개</h2></li>
				<li class="active intro-main"><a href="#">개요<span class="sr-only">(current)</span></a></li>
				<li class="hospi-master"><a href="#">원장의 말</a></li>
				<li><h2>의료진 소개</h2></li>
