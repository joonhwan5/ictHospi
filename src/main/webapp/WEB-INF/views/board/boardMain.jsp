	...
	<div class="row">
		<div class="col-sm-3 col-md-2 sidebar">
			<ul class="nav nav-sidebar">
				<li><h2>게시판</h2></li>
				<li class="active"><a href="${pageContext.request.contextPath}/board/boardMain">공지사항<span class="sr-only">(current)</span></a></li>
			...
			<div class="table-responsive">
				<table class="table table-striped">
					...
					<tbody>
						<tr>
							<td>1</td>
							<td><a href="${pageContext.request.contextPath}/board/mainDetail">첫번째 공지사항</a></td>
							<td>ICT 병원 관리자</td>
							<td>2022-12-23</td>
							<td>300</td>
						</tr>
